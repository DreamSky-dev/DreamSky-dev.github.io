...
export const EXPERIENCES: ExperienceDetails[] = [
  {
    ...
    summary: [
      'Developed an intranet portal for the bank using React, TypeScript, GraphQL and TailwindCSS',
      'Architected frontend application, GraphQL schema and queries',
      'Designed prototype UX / UI with Sketch, Zeplin',
      'Conducted React training sessions for co-workers'
    ],
  },
  {
    logo: LogoGreenApex,
    ...
    summary: [
      ...
      'Fixed slow performance issues on mobile devices.',
